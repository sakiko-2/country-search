...
const Search = ({handleInput, text}) => (
  <label className="relative w-screen rounded-md md:w-2/5">
    <SearchIcon className="pointer-events-none absolute left-2 h-7 w-7 translate-y-1/3 transform px-1 text-[color:var(--dark-gray)] focus:outline-0 dark:text-slate-400" />
    <input
      type="text"
      name="search"
      id="search"
